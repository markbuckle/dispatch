...
| Carousel | 1080 × 1350, max 8 slides |
| Story | 1080 × 1920 |
| Reel cover | 1080 × 1920, safe area 1080 × 1420 |

## Feed post

```
canvas #08080A, 72px padding
┌────────────────────────┐
│  ◦──▸            (28px)│
│                        │
│                        │
│  Twenty-three          │  display-m 40px Geist
│  email clients.        │
│  Four still don't      │
│  support flexbox.      │
│                        │
...
Hashtags: 5 maximum, in the caption not a comment, lowercase, specific: `#devtools #email #softwareengineering #api #deliverability`.

## Never

Emoji · trending audio on a product Reel · text over a photograph · face-to-camera talking-head marketing · aesthetic flat-lay of a laptop and a coffee · "link in bio 🔗" with nothing else · inspirational quote posts · anything in the brand's voice that wouldn't survive being read by an engineer
