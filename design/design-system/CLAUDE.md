...
2. **One UI typeface: Inter.** Geist for display only. Commit Mono for anything a developer would copy. Instrument Serif is allowed once per page, or not at all.
...
7. **No gradients, glows, glassmorphism, 3D, neumorphism, or illustration.** Not unless the user explicitly asks. This is the single most-violated rule; check yourself before delivering.
...
| Page title | **36px** Geist 600, -0.032em |
| Table row height | **60px**, 20px cell padding, 16px text, 48px header row |
| Heading case | Sentence case |
| Primary CTA | Light fill `#EDEEF0` on near-black, 9px radius, **38px** tall product / 44px marketing |
| Section spacing | 96px marketing, 24px product |
| Card radius | **10px**. Dialog 12px. Button/input/nav 9px. Pill 7px. |
...
4. Did I add a gradient, glow, shadow, or illustration out of habit?
